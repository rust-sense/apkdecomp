...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    */
    private UIntProgressionIterator(int r4, int r5, int r6) {
        ...
        L18:
            r3.hasNext = r0
            int r6 = kotlin.UInt.m964constructorimpl(r6)
            r3.step = r6
    ...
    public /* bridge */ /* synthetic */ UInt next() {
        return UInt.m958boximpl(m2135nextpVg5ArA());
    }

    /* renamed from: next-pVg5ArA, reason: not valid java name */
    public int m2135nextpVg5ArA() {
        int i = this.next;
        if (i != this.finalElement) {
            this.next = UInt.m964constructorimpl(this.step + i);
        } else {
            if (!this.hasNext) {
