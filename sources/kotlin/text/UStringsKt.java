...
public final class UStringsKt {
    ...
    public static final String m2237toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2239toStringolVBNx4(short s, int i) {
    ...
    public static final String m2238toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2236toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m964constructorimpl(255) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UByte.m880boximpl(UByte.m886constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m964constructorimpl(65535) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UShort.m1144boximpl(UShort.m1150constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m964constructorimpl = UInt.m964constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (i4 == 119304647) {
                    i4 = UByte$$ExternalSyntheticBackport0.m$1(-1, m964constructorimpl);
            ...
            int m964constructorimpl2 = UInt.m964constructorimpl(i3 * m964constructorimpl);
            int m964constructorimpl3 = UInt.m964constructorimpl(UInt.m964constructorimpl(digitOf) + m964constructorimpl2);
            compare2 = Integer.compare(m964constructorimpl3 ^ Integer.MIN_VALUE, m964constructorimpl2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            i3 = m964constructorimpl3;
        }
        return UInt.m958boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m1043constructorimpl = ULong.m1043constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = UByte$$ExternalSyntheticBackport0.m$1(-1L, m1043constructorimpl);
            ...
            long m1043constructorimpl2 = ULong.m1043constructorimpl(j * m1043constructorimpl);
            long m1043constructorimpl3 = ULong.m1043constructorimpl(ULong.m1043constructorimpl(UInt.m964constructorimpl(r13) & BodyPartID.bodyIdMax) + m1043constructorimpl2);
            compare2 = Long.compare(m1043constructorimpl3 ^ Long.MIN_VALUE, m1043constructorimpl2 ^ Long.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            j = m1043constructorimpl3;
        }
        return ULong.m1037boximpl(j);
    }
}
