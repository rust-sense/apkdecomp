...
class USequencesKt___USequencesKt {
    public static final int sumOfUInt(Sequence<UInt> sequence) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m964constructorimpl(i + it.next().getData());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Sequence<ULong> sequence) {
        ...
        long j = 0;
        while (it.hasNext()) {
            j = ULong.m1043constructorimpl(j + it.next().getData());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Sequence<UByte> sequence) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m964constructorimpl(i + UInt.m964constructorimpl(it.next().getData() & 255));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Sequence<UShort> sequence) {
        ...
        int i = 0;
        while (it.hasNext()) {
            i = UInt.m964constructorimpl(i + UInt.m964constructorimpl(it.next().getData() & UShort.MAX_VALUE));
        }
        return i;
    }
}
