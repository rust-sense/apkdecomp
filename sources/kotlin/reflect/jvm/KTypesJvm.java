    ...
    public static final KClass<?> getJvmErasure(KClassifier kClassifier) {
        ...
        if (kClassifier instanceof KTypeParameter) {
            ...
            while (true) {
                ...
                ClassifierDescriptor mo2189getDeclarationDescriptor = ((KTypeImpl) kType).getType().getConstructor().mo2189getDeclarationDescriptor();
                classDescriptor = mo2189getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo2189getDeclarationDescriptor : null;
