        ...
        public Data() {
            ...
            this.supertypes = ReflectProperties.lazySoft(new Function0<List<? extends KTypeImpl>>(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2
                ...
                public final List<? extends KTypeImpl> invoke() {
                    Collection<KotlinType> mo2190getSupertypes = this.this$0.getDescriptor().getTypeConstructor().mo2190getSupertypes();
                    ...
                    for (final KotlinType kotlinType : mo2190getSupertypes) {
                        ...
                        arrayList.add(new KTypeImpl(kotlinType, new Function0<Type>() { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$supertypes$2$1$1
                            ...
                            public final Type invoke() {
                                ClassifierDescriptor mo2189getDeclarationDescriptor = KotlinType.this.getConstructor().mo2189getDeclarationDescriptor();
                                if (!(mo2189getDeclarationDescriptor instanceof ClassDescriptor)) {
                                    throw new KotlinReflectionInternalError("Supertype not a class: " + mo2189getDeclarationDescriptor);
                                }
                                Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) mo2189getDeclarationDescriptor);
                                if (javaClass == null) {
                                    throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + mo2189getDeclarationDescriptor);
                                }
                                ...
                                if (indexOf < 0) {
                                    throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + mo2189getDeclarationDescriptor);
                                }
