...
public final class JavaIncompatibilityRulesOverridabilityCondition implements ExternalOverridabilityCondition {
    ...
    public static final class Companion {
        ...
        private final boolean isPrimitiveCompareTo(FunctionDescriptor functionDescriptor) {
            ...
            Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
            ClassifierDescriptor mo2189getDeclarationDescriptor = ((ValueParameterDescriptor) CollectionsKt.single((List) valueParameters)).getType().getConstructor().mo2189getDeclarationDescriptor();
            ClassDescriptor classDescriptor2 = mo2189getDeclarationDescriptor instanceof ClassDescriptor ? (ClassDescriptor) mo2189getDeclarationDescriptor : null;
