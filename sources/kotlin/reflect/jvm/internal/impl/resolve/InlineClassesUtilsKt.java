...
public final class InlineClassesUtilsKt {
    ...
    public static final boolean isInlineClassType(KotlinType kotlinType) {
        ...
        if (mo2189getDeclarationDescriptor != null) {
            return isInlineClass(mo2189getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean isValueClassType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo2189getDeclarationDescriptor = kotlinType.getConstructor().mo2189getDeclarationDescriptor();
        if (mo2189getDeclarationDescriptor != null) {
            return isValueClass(mo2189getDeclarationDescriptor);
        }
        return false;
    }
    ...
    public static final boolean needsMfvcFlattening(KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor mo2189getDeclarationDescriptor = kotlinType.getConstructor().mo2189getDeclarationDescriptor();
        return (mo2189getDeclarationDescriptor == null || !isMultiFieldValueClass(mo2189getDeclarationDescriptor) || SimpleClassicTypeSystemContext.INSTANCE.isNullableType(kotlinType)) ? false : true;
    }
