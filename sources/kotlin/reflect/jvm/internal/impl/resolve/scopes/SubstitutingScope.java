...
public final class SubstitutingScope implements MemberScope {
    ...
    public void mo2195recordLookup(Name name, LookupLocation lookupLocation) {
    ...
    public ClassifierDescriptor mo2191getContributedClassifier(Name name, LookupLocation location) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(location, "location");
        ClassifierDescriptor contributedClassifier = this.workerScope.mo2191getContributedClassifier(name, location);
