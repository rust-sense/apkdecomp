        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(pop)) {
                ...
                if (none == null) {
                    ...
                    while (it.hasNext()) {
                        SimpleTypeMarker mo2193transformType = none.mo2193transformType(typeCheckerState, it.next());
                        if ((typeSystemContext.isClassType(mo2193transformType) && !typeSystemContext.isMarkedNullable(mo2193transformType)) || typeSystemContext.isDefinitelyNotNullType(mo2193transformType)) {
        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(pop)) {
                ...
                if (supertypesPolicy == null) {
                    ...
                    Iterator<KotlinTypeMarker> it = typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(pop)).iterator();
                    while (it.hasNext()) {
                        SimpleTypeMarker mo2193transformType = supertypesPolicy.mo2193transformType(state, it.next());
                        if (INSTANCE.isApplicableAsEndNode(state, mo2193transformType, end)) {
                            state.clear();
                            return true;
                        }
                        supertypesDeque.add(mo2193transformType);
