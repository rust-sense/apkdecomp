...
public abstract class KotlinBuiltIns {
    ...
    protected KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor contributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo2191getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
    ...
    private static KotlinType getElementTypeForUnsignedArray(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        if (mo2189getDeclarationDescriptor == null || !UnsignedTypes.INSTANCE.isShortNameOfUnsignedArray(mo2189getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(mo2189getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = UnsignedTypes.INSTANCE.getUnsignedClassIdByArrayClassId(classId)) == null || (findClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo2189getDeclarationDescriptor = kotlinType.getConstructor().mo2189getDeclarationDescriptor();
        return (mo2189getDeclarationDescriptor == null || getPrimitiveArrayType(mo2189getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(mo2189getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo2189getDeclarationDescriptor = kotlinType.getConstructor().mo2189getDeclarationDescriptor();
        return (mo2189getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) mo2189getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (mo2189getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(mo2189getDeclarationDescriptor, fqNameUnsafe);
    }
