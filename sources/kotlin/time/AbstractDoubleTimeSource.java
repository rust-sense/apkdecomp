...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo2240elapsedNowUwyO8pc() {
            return Duration.m2285minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo2243plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m2286plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo2242minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, doubleTimeMark.timeSource)) {
                    if (Duration.m2255equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m2282isInfiniteimpl(this.offset)) {
                        return Duration.INSTANCE.m2353getZEROUwyO8pc();
                    }
                    long m2285minusLRDsOJo = Duration.m2285minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m2255equalsimpl0(duration, Duration.m2303unaryMinusUwyO8pc(m2285minusLRDsOJo)) ? Duration.INSTANCE.m2353getZEROUwyO8pc() : Duration.m2286plusLRDsOJo(duration, m2285minusLRDsOJo);
                }
            }
        ...
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m2255equalsimpl0(mo2242minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m2353getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m2278hashCodeimpl(Duration.m2286plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m2299toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m2353getZEROUwyO8pc(), null);
    }
}
