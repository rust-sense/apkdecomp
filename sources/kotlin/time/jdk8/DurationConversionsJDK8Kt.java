...
public final class DurationConversionsJDK8Kt {
    private static final long toKotlinDuration(Duration duration) {
        ...
        return kotlin.time.Duration.m2286plusLRDsOJo(duration2, DurationKt.toDuration(nano, DurationUnit.NANOSECONDS));
    }

    /* renamed from: toJavaDuration-LRDsOJo, reason: not valid java name */
    private static final Duration m2412toJavaDurationLRDsOJo(long j) {
        Duration ofSeconds;
        ofSeconds = Duration.ofSeconds(kotlin.time.Duration.m2271getInWholeSecondsimpl(j), kotlin.time.Duration.m2273getNanosecondsComponentimpl(j));
