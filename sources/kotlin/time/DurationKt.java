...
public final class DurationKt {
    ...
    private static final long m2377timesmvk6XK0(int i, long j) {
        return Duration.m2288timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m2376timeskIfJnKk(double d, long j) {
        return Duration.m2287timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long m2353getZEROUwyO8pc = Duration.INSTANCE.m2353getZEROUwyO8pc();
        ...
        if (str2.charAt(i) == 'P') {
            ...
            while (i2 < length) {
                if (str2.charAt(i2) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        z4 = z8;
                        long m2286plusLRDsOJo = Duration.m2286plusLRDsOJo(m2353getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "substring(...)");
                        m2353getZEROUwyO8pc = Duration.m2286plusLRDsOJo(m2286plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        z4 = z8;
                        m2353getZEROUwyO8pc = Duration.m2286plusLRDsOJo(m2353getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
                    z8 = z4;
            ...
            if (StringsKt.regionMatches(str, i, "Infinity", 0, Math.max(length - i, 8), true)) {
                m2353getZEROUwyO8pc = Duration.INSTANCE.m2351getINFINITEUwyO8pc();
            } else {
                boolean z9 = !z6;
                ...
                while (i < length) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m2286plusLRDsOJo2 = Duration.m2286plusLRDsOJo(m2353getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "substring(...)");
                        m2353getZEROUwyO8pc = Duration.m2286plusLRDsOJo(m2286plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m2353getZEROUwyO8pc = Duration.m2286plusLRDsOJo(m2353getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
                    str2 = str;
                    str5 = str7;
        ...
        return z2 ? Duration.m2303unaryMinusUwyO8pc(m2353getZEROUwyO8pc) : m2353getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m2250constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m2250constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m2250constructorimpl((j << 1) + i);
    }
