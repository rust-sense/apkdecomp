...
public interface TimeMark {
    ...
    TimeMark mo2241minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2243plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2388plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2387minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo2243plusLRDsOJo(Duration.m2303unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2283isNegativeimpl(timeMark.mo2240elapsedNowUwyO8pc());
        }
