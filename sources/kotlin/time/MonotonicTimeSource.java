...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2390boximpl(m2384markNowz9LOYto());
    }
    ...
    public long m2384markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2393constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2383elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2382differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2381adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2393constructorimpl(LongSaturatedMathKt.m2379saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
