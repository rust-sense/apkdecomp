...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2241minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2387minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo2240elapsedNowUwyO8pc() {
        return Duration.m2285minusLRDsOJo(this.mark.mo2240elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo2243plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2286plusLRDsOJo(this.adjustment, duration), null);
    }
}
