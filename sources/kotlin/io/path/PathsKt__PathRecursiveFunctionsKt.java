...
class PathsKt__PathRecursiveFunctionsKt extends PathsKt__PathReadWriteKt {
        ...
        if ((i & 2) != 0) {
            function3 = new Function3() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$1
                ...
                public /* bridge */ /* synthetic */ Object invoke(Object obj2, Object obj3, Object obj4) {
                    return invoke(SentryWrapper$$ExternalSyntheticApiModelOutline0.m793m(obj2), SentryWrapper$$ExternalSyntheticApiModelOutline0.m793m(obj3), (Exception) obj4);
                }
        ...
        if (z2) {
            return PathsKt.copyToRecursively(path, target, onError, z, new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$2
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path2, Path path3) {
                    return invoke2(copyActionContext, SentryWrapper$$ExternalSyntheticApiModelOutline0.m793m((Object) path2), SentryWrapper$$ExternalSyntheticApiModelOutline0.m793m((Object) path3));
                }
        ...
        if ((i & 8) != 0) {
            function32 = new Function3<CopyActionContext, Path, Path, CopyActionResult>() { // from class: kotlin.io.path.PathsKt__PathRecursiveFunctionsKt$copyToRecursively$4
                ...
                public /* bridge */ /* synthetic */ CopyActionResult invoke(CopyActionContext copyActionContext, Path path3, Path path4) {
                    return invoke2(copyActionContext, SentryWrapper$$ExternalSyntheticApiModelOutline0.m793m((Object) path3), SentryWrapper$$ExternalSyntheticApiModelOutline0.m793m((Object) path4));
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x00af, code lost:
        ...
        io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m$2();
     */
    /* JADX WARN: Code restructure failed: missing block: B:22:0x00c0, code lost:
    
        throw kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(r6.toString(), r7.toString(), "Recursively copying a directory into its subdirectory is prohibited.");
     */
    ...
    */
    public static final java.nio.file.Path copyToRecursively(final java.nio.file.Path r6, final java.nio.file.Path r7, final kotlin.jvm.functions.Function3<? super java.nio.file.Path, ? super java.nio.file.Path, ? super java.lang.Exception, ? extends kotlin.io.path.OnErrorResult> r8, boolean r9, final kotlin.jvm.functions.Function3<? super kotlin.io.path.CopyActionContext, ? super java.nio.file.Path, ? super java.nio.file.Path, ? extends kotlin.io.path.CopyActionResult> r10) {
        /*
            ...
            java.lang.Object[] r0 = java.util.Arrays.copyOf(r0, r1)
            java.nio.file.LinkOption[] r0 = (java.nio.file.LinkOption[]) r0
            boolean r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2107m(r6, r0)
            if (r0 == 0) goto Ld2
            r0 = 0
            java.nio.file.LinkOption[] r1 = new java.nio.file.LinkOption[r0]
            java.lang.Object[] r1 = java.util.Arrays.copyOf(r1, r0)
            java.nio.file.LinkOption[] r1 = (java.nio.file.LinkOption[]) r1
            boolean r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2107m(r6, r1)
            if (r1 == 0) goto Lc1
            if (r9 != 0) goto L45
            boolean r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2105m(r6)
            if (r1 != 0) goto Lc1
        L45:
            java.nio.file.LinkOption[] r1 = new java.nio.file.LinkOption[r0]
            java.lang.Object[] r1 = java.util.Arrays.copyOf(r1, r0)
            java.nio.file.LinkOption[] r1 = (java.nio.file.LinkOption[]) r1
            boolean r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2107m(r7, r1)
            if (r1 == 0) goto L5b
            boolean r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2105m(r7)
            if (r1 != 0) goto L5b
            r1 = 1
            goto L5c
        L5b:
        ...
        L5c:
            if (r1 == 0) goto L64
            boolean r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2106m(r6, r7)
            if (r2 != 0) goto Lc1
        L64:
            java.nio.file.FileSystem r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2084m(r6)
            java.nio.file.FileSystem r3 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2084m(r7)
        ...
        L73:
            ...
            boolean r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2116m$1(r1, r0)
            if (r0 != 0) goto Laf
            goto Lc1
        L88:
            java.nio.file.Path r1 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m$1(r7)
            if (r1 == 0) goto Lc1
            ...
            boolean r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2107m(r1, r2)
            if (r2 == 0) goto Lc1
            java.nio.file.LinkOption[] r2 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r1 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(r1, r2)
            java.nio.file.LinkOption[] r0 = new java.nio.file.LinkOption[r0]
            java.nio.file.Path r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(r6, r0)
            boolean r0 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2116m$1(r1, r0)
            if (r0 != 0) goto Laf
        ...
        Lc1:
            ...
            return r7
        Ld2:
            kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2114m$1()
            java.lang.String r6 = r6.toString()
            java.lang.String r7 = r7.toString()
            java.lang.String r8 = "The source file doesn't exist."
            java.nio.file.NoSuchFileException r6 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2086m(r6, r7, r8)
            throw r6
        */
    ...
    public static final void deleteRecursively(Path path) {
        ...
        if (!deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt.isEmpty()) {
            FileSystemException m788m = SentryWrapper$$ExternalSyntheticApiModelOutline0.m788m("Failed to delete one or more files. See suppressed exceptions for details.");
            Iterator<T> it = deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt.iterator();
            while (it.hasNext()) {
                ExceptionsKt.addSuppressed(m788m, (Exception) it.next());
            }
            throw m788m;
        }
    }
    ...
    */
    private static final java.util.List<java.lang.Exception> deleteRecursivelyImpl$PathsKt__PathRecursiveFunctionsKt(java.nio.file.Path r8) {
        /*
            ...
            r3 = 0
            r0.<init>(r1, r2, r3)
            java.nio.file.Path r4 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m$1(r8)
            if (r4 == 0) goto L46
            java.nio.file.DirectoryStream r5 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2082m(r4)     // Catch: java.lang.Throwable -> L13
            goto L14
        L13:
            r5 = r3
        L14:
            ...
            java.nio.file.DirectoryStream r6 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m(r5)     // Catch: java.lang.Throwable -> L3f
            boolean r7 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2104m(r6)     // Catch: java.lang.Throwable -> L3f
            if (r7 == 0) goto L36
            r0.setPath(r4)     // Catch: java.lang.Throwable -> L3f
            java.nio.file.SecureDirectoryStream r2 = kotlin.io.path.PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2089m(r6)     // Catch: java.lang.Throwable -> L3f
            java.nio.file.Path r4 = io.sentry.SentryWrapper$$ExternalSyntheticApiModelOutline0.m(r8)     // Catch: java.lang.Throwable -> L3f
    ...
    private static final void enterDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            SecureDirectoryStream m2089m = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2089m((Object) secureDirectoryStream3);
            it = m2089m.iterator();
            while (it.hasNext()) {
                fileName = SentryWrapper$$ExternalSyntheticApiModelOutline0.m793m(it.next()).getFileName();
                Intrinsics.checkNotNullExpressionValue(fileName, "getFileName(...)");
                handleEntry$PathsKt__PathRecursiveFunctionsKt(m2089m, fileName, exceptionsCollector);
            }
            Unit unit = Unit.INSTANCE;
    ...
    private static final boolean isDirectory$PathsKt__PathRecursiveFunctionsKt(SecureDirectoryStream<Path> secureDirectoryStream, Path path, LinkOption... linkOptionArr) {
        ...
        try {
            ...
            readAttributes = PathTreeWalk$$ExternalSyntheticApiModelOutline0.m2092m((Object) fileAttributeView).readAttributes();
    ...
    private static final void insecureEnterDirectory$PathsKt__PathRecursiveFunctionsKt(Path path, ExceptionsCollector exceptionsCollector) {
        ...
        try {
            ...
            while (it.hasNext()) {
                Path m793m = SentryWrapper$$ExternalSyntheticApiModelOutline0.m793m(it.next());
                Intrinsics.checkNotNull(m793m);
                insecureHandleEntry$PathsKt__PathRecursiveFunctionsKt(m793m, exceptionsCollector);
            }
            Unit unit = Unit.INSTANCE;
