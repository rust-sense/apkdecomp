...
final class ExceptionsCollector {
    ...
    public final void collect(Exception exception) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                SentryWrapper$$ExternalSyntheticApiModelOutline0.m$2();
                initCause = SentryWrapper$$ExternalSyntheticApiModelOutline0.m788m(String.valueOf(this.path)).initCause(exception);
                Intrinsics.checkNotNull(initCause, "null cannot be cast to non-null type java.nio.file.FileSystemException");
                exception = SentryWrapper$$ExternalSyntheticApiModelOutline0.m787m((Object) initCause);
            }
