...
public final class Scope implements IScope {
    ...
    public Session withSession(IWithSession iWithSession) {
        ...
        synchronized (this.sessionLock) {
            ...
            m801clone = this.session != null ? this.session.m801clone() : null;
        }
        return m801clone;
    }
    ...
    public SessionPair startSession() {
        ...
        synchronized (this.sessionLock) {
            ...
            if (this.options.getRelease() != null) {
                ...
                sessionPair = new SessionPair(this.session.m801clone(), session != null ? session.m801clone() : null);
            } else {
    ...
    public Session endSession() {
        ...
        synchronized (this.sessionLock) {
            ...
            if (this.session != null) {
                this.session.end();
                Session m801clone = this.session.m801clone();
                this.session = null;
                session = m801clone;
            }
        }
