    ...
    public final void run() {
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                        ...
                        continuation.resumeWith(Result.m868constructorimpl(ResultKt.createFailure(cancellationException)));
                    }
                    cancellationException = cancellationException2;
                    continuation.resumeWith(Result.m868constructorimpl(ResultKt.createFailure(cancellationException)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m868constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    Result.Companion companion3 = Result.INSTANCE;
                    continuation.resumeWith(Result.m868constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
                }
                ...
                try {
                    ...
                    m868constructorimpl2 = Result.m868constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    m868constructorimpl2 = Result.m868constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m871exceptionOrNullimpl(m868constructorimpl2));
            } finally {
            ...
            try {
                ...
                m868constructorimpl = Result.m868constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m871exceptionOrNullimpl(m868constructorimpl));
        }
    }
