...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m868constructorimpl = Result.m868constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m868constructorimpl = Result.m868constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m874isFailureimpl(m868constructorimpl) ? null : m868constructorimpl);
        if (bool != null) {
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m2454installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m2454installSignalHandler$lambda1(Signal signal) {
