...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m868constructorimpl = Result.m868constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), objArr2 == true ? 1 : 0, 2, objArr == true ? 1 : 0));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m868constructorimpl = Result.m868constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m874isFailureimpl(m868constructorimpl) ? null : m868constructorimpl);
    }
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m2428postFrameCallback$lambda6(CancellableContinuation.this, j);
            }
        });
    }
    ...
    public static final void m2428postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo2477dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
