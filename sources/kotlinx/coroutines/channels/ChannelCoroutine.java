...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2430receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2430receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2431tryReceivePtdJZtk() {
        return this._channel.mo2431tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2432trySendJP2dKIU(E element) {
        return this._channel.mo2432trySendJP2dKIU(element);
    }
