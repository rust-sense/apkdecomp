...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    */
    ...
    public final Object mo2432trySendJP2dKIU(E element) {
        Object offerInternal = offerInternal(element);
        if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
            return ChannelResult.INSTANCE.m2452successJP2dKIU(Unit.INSTANCE);
        }
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            Closed<?> closedForSend = getClosedForSend();
            return closedForSend == null ? ChannelResult.INSTANCE.m2451failurePtdJZtk() : ChannelResult.INSTANCE.m2450closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        }
        if (offerInternal instanceof Closed) {
            return ChannelResult.INSTANCE.m2450closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        }
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 != null && (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) != null) {
            ...
            continuation.resumeWith(Result.m868constructorimpl(ResultKt.createFailure(undeliveredElementException)));
            return;
        }
        Result.Companion companion2 = Result.INSTANCE;
        continuation.resumeWith(Result.m868constructorimpl(ResultKt.createFailure(sendException)));
    }
    ...
    private final void helpClose(Closed<?> closed) {
        ...
        while (true) {
            ...
            if (receive == null) {
                break;
            } else if (!receive.mo2476remove()) {
                receive.helpRemove();
            } else {
                m2468constructorimpl$default = InlineList.m2473plusFjFbRPM(m2468constructorimpl$default, receive);
            }
        }
        if (m2468constructorimpl$default != null) {
            if (!(m2468constructorimpl$default instanceof ArrayList)) {
                ((Receive) m2468constructorimpl$default).resumeReceiveClosed(closed);
            } else if (m2468constructorimpl$default != null) {
                ArrayList arrayList = (ArrayList) m2468constructorimpl$default;
    ...
    */
    ...
    public final Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                Result.Companion companion = Result.INSTANCE;
                cancellableContinuationImpl.resumeWith(Result.m868constructorimpl(Unit.INSTANCE));
                break;
            }
            if (offerInternal != AbstractChannelKt.OFFER_FAILED) {
                if (offerInternal instanceof Closed) {
