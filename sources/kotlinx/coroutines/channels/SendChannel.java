...
public interface SendChannel<E> {
    ...
    Object mo2432trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo2432trySendJP2dKIU = sendChannel.mo2432trySendJP2dKIU(e);
            if (ChannelResult.m2447isSuccessimpl(mo2432trySendJP2dKIU)) {
                return true;
            }
            Throwable m2441exceptionOrNullimpl = ChannelResult.m2441exceptionOrNullimpl(mo2432trySendJP2dKIU);
