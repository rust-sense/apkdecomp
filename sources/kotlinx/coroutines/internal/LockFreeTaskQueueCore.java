    ...
    */
    ...
    public final <R> List<R> map(Function1<? super E, ? extends R> transform) {
        ...
        while (true) {
            int i3 = this.mask;
            if ((i & i3) != (i2 & i3)) {
                R.attr attrVar = (Object) this.array.get(i3 & i);
                if (attrVar != null && !(attrVar instanceof Placeholder)) {
                    arrayList.add(transform.invoke(attrVar));
                }
                i++;
            } else {
                return arrayList;
