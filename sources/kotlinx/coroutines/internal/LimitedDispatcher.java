...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo2478scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo2478scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    */
    ...
    public void mo2477dispatch(CoroutineContext context, Runnable block) {
        ...
        this.dispatcher.mo2477dispatch(this, this);
    }
