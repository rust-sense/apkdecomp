...
public final class InlineList<E> {
    ...
    public static final /* synthetic */ InlineList m2466boximpl(Object obj) {
        return new InlineList(obj);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    public static <E> Object m2467constructorimpl(Object obj) {
        return obj;
    }
    ...
    public boolean equals(Object obj) {
        return m2469equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m2472hashCodeimpl(this.holder);
    }

    public String toString() {
        return m2474toStringimpl(this.holder);
    }
    ...
    public static /* synthetic */ Object m2468constructorimpl$default(Object obj, int i, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i & 1) != 0) {
            obj = null;
        }
        return m2467constructorimpl(obj);
    }

    /* renamed from: plus-FjFbRPM, reason: not valid java name */
    public static final Object m2473plusFjFbRPM(Object obj, E e) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(e instanceof List))) {
            throw new AssertionError();
        }
        if (obj == null) {
            return m2467constructorimpl(e);
        }
        ...
        arrayList.add(obj);
        arrayList.add(e);
        return m2467constructorimpl(arrayList);
    }

    /* renamed from: forEachReversed-impl, reason: not valid java name */
    public static final void m2471forEachReversedimpl(Object obj, Function1<? super E, Unit> function1) {
        if (obj == null) {
            return;
        }
        if (!(obj instanceof ArrayList)) {
