...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            ...
            resumeWith(Result.m868constructorimpl(ResultKt.createFailure(e)));
        } else {
    ...
    public void resumeWith(Object result) {
        ...
        while (true) {
            ...
            if (obj4 == obj) {
                ...
                obj3 = SelectKt.RESUMED;
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj3)) {
                    if (Result.m874isFailureimpl(result)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable m871exceptionOrNullimpl = Result.m871exceptionOrNullimpl(result);
                        Intrinsics.checkNotNull(m871exceptionOrNullimpl);
                        Result.Companion companion = Result.INSTANCE;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            m871exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m871exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m868constructorimpl(ResultKt.createFailure(m871exceptionOrNullimpl)));
                        return;
                    }
        ...
        while (true) {
            ...
            if (obj4 == obj) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceFieldUpdater2, this, coroutine_suspended, obj3)) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    intercepted.resumeWith(Result.m868constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            }
        }
