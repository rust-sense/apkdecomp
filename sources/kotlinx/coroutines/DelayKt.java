...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2478scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2414delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2415toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2415toDelayMillisLRDsOJo(long j) {
        if (Duration.m2249compareToLRDsOJo(j, Duration.INSTANCE.m2353getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2268getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
