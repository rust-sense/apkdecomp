...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition mo151clone = transition.mo151clone();
        mo151clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            mo151clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, mo151clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, mo151clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition mo151clone = transition.mo151clone();
        sceneChangeSetup(viewGroup, mo151clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, mo151clone);
    }
