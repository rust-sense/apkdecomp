    ...
    public void saveAttributes() throws IOException {
        ...
        try {
            if (this.mFilename != null) {
                file = new File(this.mFilename + DefaultDiskStorage.FileType.TEMP);
