...
public final class AnimatedWebpDecoder {
    ...
    Resource<Drawable> decode(ImageDecoder.Source source, int i, int i2, Options options) throws IOException {
        ...
        if (!Intl$$ExternalSyntheticApiModelOutline0.m227m((Object) decodeDrawable)) {
            throw new IOException("Received unexpected drawable type for animated webp, failing: " + decodeDrawable);
        }
        return new AnimatedImageDrawableResource(Intl$$ExternalSyntheticApiModelOutline0.m202m((Object) decodeDrawable));
    }
