...
public final class SerializationUtilsKt {
    ...
    public static final WritableMap rectToJsMap(Rect rect) {
        ...
        WritableMap createMap = Arguments.createMap();
        createMap.putDouble(ViewHierarchyNode.JsonKeys.X, PixelUtil.toDIPFromPixel(rect.getX()));
        createMap.putDouble(ViewHierarchyNode.JsonKeys.Y, PixelUtil.toDIPFromPixel(rect.getY()));
