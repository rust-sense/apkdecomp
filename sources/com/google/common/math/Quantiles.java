        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            while (true) {
                ...
                if (i < iArr6.length) {
                    ...
                    int i7 = iArr4[i];
                    if (i7 == 0) {
                        hashMap2.put(Integer.valueOf(iArr6[i]), Double.valueOf(dArr[i6]));
                    } else {
                        hashMap2.put(Integer.valueOf(iArr6[i]), Double.valueOf(Quantiles.interpolate(dArr[i6], dArr[i6 + 1], i7, this.scale)));
                    }
                    i++;
                } else {
