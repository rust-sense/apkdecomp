...
public final class ExecutionSequencer {
    ...
    public <T> ListenableFuture<T> submitAsync(final AsyncCallable<T> asyncCallable, final Executor executor) {
        ...
        AsyncCallable<T> asyncCallable2 = new AsyncCallable<T>() { // from class: com.google.common.util.concurrent.ExecutionSequencer.2
            @Override // com.google.common.util.concurrent.AsyncCallable
            public ListenableFuture<T> call() throws Exception {
                if (!DestructorThread$DestructorStack$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, RunningState.NOT_RUN, RunningState.STARTED)) {
        ...
        Runnable runnable = new Runnable() { // from class: com.google.common.util.concurrent.ExecutionSequencer.4
            ...
            public void run() {
                if (submitAsync.isDone() || (nonCancellationPropagating.isCancelled() && DestructorThread$DestructorStack$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, RunningState.NOT_RUN, RunningState.CANCELLED))) {
