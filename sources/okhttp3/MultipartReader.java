...
public final class MultipartReader implements Closeable {
    ...
    private static final Options afterBoundaryOptions = Options.INSTANCE.of(ByteString.INSTANCE.encodeUtf8(IOUtils.LINE_SEPARATOR_WINDOWS), ByteString.INSTANCE.encodeUtf8("--"), ByteString.INSTANCE.encodeUtf8(StringUtils.SPACE), ByteString.INSTANCE.encodeUtf8("\t"));
